...
create table if not exists prof(id bigserial primary key,firstname varchar (50),lastname varchar(50),username varchar (50),password varchar (50),jobtype varchar(50));
